            ...
            <div>
                ...
                <div className='flex justify-center relative my-20'>
                    <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                        <h1 className='uppercase tracking-widest  text-center text-blue-100 max-w-80 text-3xl font-semibold animate-in transform:'>Turki Saleh</h1>

                        <h2 className='text-center md:tracking-wider bg-gradient-to-r from-purple-600 to-blue-400 bg-clip-text text-3xl text-transparent font-serif capitalize'>Software Engineer</h2>

                        <TextGenerateEffect className='text-center text-blue-100 text-2xl' duration={0.1} words={"Full Stack Developer building responsive and scalable web applications using modern front-end and back-end technologies. Implementing end-to-end solutions. Developing RESTful APIs, and working with databases. With maintainable code"} />

                        <div className='flex gap-4 items-center mt-14'>
                            <a href="#about" className='flex flex-shrink items-center justify-center'>
